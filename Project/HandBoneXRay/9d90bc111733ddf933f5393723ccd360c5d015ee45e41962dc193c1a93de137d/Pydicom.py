...
dicom_data = pydicom.dcmread("D:\\Python learning\\Project\\HandBoneXRay\\9d90bc111733ddf933f5393723ccd360c5d015ee45e41962dc193c1a93de137d.dcm", force=True)
...
# 第一張圖 - Rotated Image
axes[0, 0].imshow(rotated, cmap=plt.cm.gray)
axes[0, 0].set_title('Rotated Image')
# 第二張圖 - Rotated img_final
axes[0, 1].imshow(img_final, cmap=plt.cm.bone)
axes[0, 1].set_title('Rotated img_final')
# 第三張圖 - 原始影像（pixel_data）
axes[1, 0].imshow(pixel_data, cmap=plt.cm.gray)
axes[1, 0].set_title('Original Image')
# 第四張圖 - contour_image
axes[1, 1].imshow(threshold, cmap=plt.cm.bone)
axes[1, 1].set_title('Contour Image')
# 調整子圖之間的間距
plt.tight_layout()
# 顯示畫布
plt.show()
...
new_dicom_data.is_implicit_VR = False  
